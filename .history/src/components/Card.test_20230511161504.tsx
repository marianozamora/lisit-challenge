...
describe('Card', () => {
    test('renders card component', () => {
        ...
        expect(screen.getByRole('heading', { name: /Luke Skywalker/i })).toBeDefined();
        expect(screen.getByText(/Birth Year:/i)).toBeDefined();
        expect(screen.getByText(/19BBY/i)).toBeDefined();
        expect(screen.getByLabelText(/add to favorites/i)).toBeDefined();
        expect(screen.getByLabelText(/AirplanemodeActive/i)).toBeDefined();
